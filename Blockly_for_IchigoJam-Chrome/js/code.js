...
// ChromeAppsではdocument.writeは使用できないらしい？
// document.write('<script src="msg/' + Code.LANG + '.js"></script>\n');
// document.writeをdocument.createElementを使ったコードに書き換える必要がある
var script1 = document.createElement('script');
  script1.src = 'msg/' + Code.LANG + '.js';
  script1.type = 'text/javascript';
  goog.global.document.getElementsByTagName("head")[0].appendChild(script1);

// Load Blockly's language strings.
// ChromeAppsではdocument.writeは使用できないらしい？
// document.write('<script src="msg/master-msg/' + Code.LANG + '.js"></script>\n');
// document.writeをdocument.createElementを使ったコードに書き換える必要がある
var script2 = document.createElement('script');
  script2.src = 'msg/master-msg/' + Code.LANG + '.js';
  script2.type = 'text/javascript';
  goog.global.document.getElementsByTagName("head")[0].appendChild(script2);
